...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Headline: staggered per-word reveal */}
      <div className="relative z-10 mb-8 text-center overflow-hidden px-4">
        <h1 className="font-display font-semibold text-3xl sm:text-5xl leading-tight text-white flex flex-wrap justify-center gap-x-3">
          {words.map((word, i) => (
