  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center" style={{ boxShadow: '0 2px 16px rgba(0,0,0,0.06)' }}>
      ...
      <div className="flex items-center justify-center gap-3 mt-5">
        <Link href="/admin/batches/new" className="inline-flex items-center gap-2 bg-amber-500 text-white font-semibold text-sm px-4 py-2.5 rounded-xl hover:bg-amber-400 transition-colors">
          <PlusCircle size={15} /> New Batch
        </Link>
        <Link href="/admin/expenses/new" className="inline-flex items-center gap-2 bg-white border border-gray-200 text-gray-700 font-semibold text-sm px-4 py-2.5 rounded-xl hover:bg-gray-50 transition-colors">
